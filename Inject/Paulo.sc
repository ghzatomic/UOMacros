# http://forum.yoko.com.ua - Script examples and tutorials
# http://yoko.com.ua/eng/install.htm - latest version
...
#     UO.LClick(X,Y), UO.RClick(X,Y), UO.LDblClick(X,Y), UO.RDblClick(X,Y)
...
# If AutoStart option enabled, function autostart() will be launched
# upon successful entering world.
